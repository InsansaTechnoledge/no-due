...
const EditDrawer = ({ reminder, onClose }) => {
    return (
              ...
              <div className="h-full flex flex-col bg-white shadow-xl">
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="rounded-lg border border-gray-200 p-4 bg-gray-50">
                        ...
                        <div className="text-sm text-gray-600 mt-1">{reminder.customer.company}</div>
                        <div className="text-xs text-gray-500 mt-1">ID: {reminder.customer.id}</div>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        <input 
                          type="datetime-local" 
                          defaultValue={reminder.sendAt?.slice(0,16)} 
                          className="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                        />
                        <button className="w-full inline-flex items-center justify-center gap-2 border border-gray-300 px-4 py-2 rounded-lg hover:bg-gray-50 text-sm font-medium transition-colors">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {reminder.status === "scheduled" && (
                          <button className="px-3 py-1.5 border border-amber-200 rounded-lg text-xs font-medium text-amber-700 hover:bg-amber-50 transition-colors">
                            Pause
                          </button>
                        )}
                      </div>
                ...
                <div className="flex-shrink-0 px-6 py-4 bg-gray-50 border-t border-gray-200">
                  <div className="flex items-center justify-between gap-3">
                    <button className="flex-1 px-4 py-2 border border-red-200 text-red-600 rounded-lg text-sm font-medium hover:bg-red-50 transition-colors inline-flex items-center justify-center gap-2">
