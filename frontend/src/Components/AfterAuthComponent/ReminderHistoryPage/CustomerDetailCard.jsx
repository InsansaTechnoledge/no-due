...
const CustomerDetailCard = ({CustomerNames , imgFor , openDetails}) => {
  return (
                ...
                >
                  ...
                  <div className="w-full space-y-2 mb-4">
                    <div className="flex items-center gap-2 text-xs text-gray-600">
                      ...
                      <span className="truncate">{customer.id || 'CUST-1234'}</span>
                    </div>
                    <div className="flex items-center gap-2 text-xs text-gray-600">
                  ...
                  <button
                    ...
                    className="w-full px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                  >
                    View Details
                  </button>
                </div>
