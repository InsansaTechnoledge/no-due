...
const MobileCustomerDetailCard = ({CustomerNames , imgFor , openDetails , setDetailedView , setSelectedCustomer, selectedCustomer, detailedView, sampleReminders}) => {
  return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 text-xs text-gray-500 mt-0.5">
                        ...
                        <span>•</span>
                        <span className="truncate">ID: {c.id || 'CUST-1234'}</span>
                      </div>
                    </div>
                        ...
                        {sampleReminders.map((r) => (
                          ...
                          >
                            <div className="flex items-center justify-between mb-2">
                              ...
                              <span className="text-xs font-medium text-gray-700 bg-white px-2 py-1 rounded border border-gray-200">{r.channel}</span>
                            </div>
                            <span
