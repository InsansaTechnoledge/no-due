...
const Hero = () => {
  return (
    <div className=" w-full  text-center">
      ...
      <section id="features" className="min-h-[50vh] mt-10  flex items-center justify-center">
        <Features/>
      </section>
      <section id="pricing" className="min-h-[50vh]  flex items-center justify-center">
        <Pricing />
      </section>
    </div>
  );
